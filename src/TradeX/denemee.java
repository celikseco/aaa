 ...
 * @author seckin.celik
 */
public class denemee extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(denemee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
