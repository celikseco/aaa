...
public class uyekayit extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String uyeAdi;String uyesoyAdi;String emaili;String passwor="";
        
        if(isPasswordCorrect(jPasswordField1.getPassword(),jPasswordField2.getPassword())){
            
        uyeAdi=jTextField1.getText();
        uyesoyAdi=jTextField2.getText();
        emaili=jTextField3.getText();
        for(int i=0;i<jPasswordField1.getPassword().length;i++){
        passwor=passwor+Character.toString(jPasswordField1.getPassword()[i]);
        }
        dbo.dealSave ilkuyekayti=new dbo.dealSave();
        ilkuyekayti.newUser(uyeAdi,uyesoyAdi,passwor,emaili);
        jTextField1.setText(emaili);
        jPasswordField1.setText(passwor);
        JOptionPane.showMessageDialog(rootPane, "User account has been created! ");
        this.dispose();
        }
        else{
                JOptionPane.showMessageDialog(rootPane, "Check the information you entered! ");
            this.dispose();
        }
    ...
    private static boolean isPasswordCorrect(char[] input,char [] input1) {
    boolean isCorrect = true;

    if (input.length != input1.length) {
        isCorrect = false;
    } else {
        isCorrect = Arrays.equals (input, input1);
    }
